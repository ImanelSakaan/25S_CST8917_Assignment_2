...
|-----------------------|---------------------------|-------------------------|--------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| **Azure Functions**   | AWS Lambda                | Cloud Functions         | Integrates with Azure services (Storage, Event Grid, Service Bus, Cosmos DB), GitHub Actions, Azure DevOps   | Azure Monitor, Application Insights                                                        |
| **Durable Functions** | AWS Step Functions        | Workflows               | Works with Azure Functions and other Azure services                                                          | Azure Monitor, Application Insights                                                        |
| **Azure Logic Apps**  | Step Functions + AppFlow  | Workflows + Automation  | Connectors to SaaS, on-prem, Azure services; CI/CD via Azure DevOps, GitHub Actions                          | Azure Monitor, Run History, Application Insights                                           |
| **Azure Service Bus** | SQS + SNS                 | Pub/Sub                 | Works with Azure Functions, Logic Apps, Event Grid                                                           | Azure Monitor, Service Bus Explorer                                                        |
| **Azure Event Grid**  | EventBridge               | Eventarc                 | Azure Functions, Logic Apps, Service Bus, WebHooks                                                           | Azure Monitor, Diagnostic Logs                                                             |
| **Azure Event Hubs**  | Kinesis Data Streams      | Pub/Sub (Streaming)     | Azure Stream Analytics, Functions, Databricks                                                                | Azure Monitor, Metrics, Logs                                                               |
